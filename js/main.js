...
(function() {
  ...
  Game.prototype._loadImages = function() {
    ...
    load('melee_sprite_run', 'assets/strips/zero_run_6f.png');
  ...
  Game.prototype._initGame = function() {
    ...
    if (this._selectedCharacter.id === 'melee') {
      var meleeCfg = { sprites: { idle: { file: 'assets/strips/zero_idle_4f.png', fps: 6 }, run: { file: 'assets/strips/zero_run_6f.png', fps: 10 } } };
