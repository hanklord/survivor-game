...
(function() {
  ...
  Game.prototype._loadImages = function() {
    ...
    load('melee_sprite_idle', 'assets/strips/fknight_idle_6f.png');
    load('melee_sprite_run', 'assets/strips/fknight_run_6f.png');
  ...
  Game.prototype._initGame = function() {
    ...
    if (this._selectedCharacter.id === 'melee') {
      var meleeCfg = { sprites: { idle: { file: 'assets/strips/fknight_idle_6f.png', fps: 8 }, run: { file: 'assets/strips/fknight_run_6f.png', fps: 10 } } };
