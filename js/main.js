...
(function() {
  ...
  Game.prototype._loadImages = function() {
    ...
    load('melee_sprite_idle', 'assets/strips/girl_idle_6f.png');
    load('melee_sprite_run', 'assets/strips/girl_walk_3f.png');
  ...
  Game.prototype._initGame = function() {
    ...
    if (this._selectedCharacter.id === 'melee') {
      var meleeCfg = { sprites: { idle: { file: 'assets/strips/girl_idle_6f.png', fps: 8 }, run: { file: 'assets/strips/girl_walk_3f.png', fps: 8 } } };
