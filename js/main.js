...
(function() {
  ...
  Game.prototype._loadImages = function() {
    ...
    load('melee_sprite_idle', 'assets/strips/melee_idle_2f.png');
    load('melee_sprite_run', 'assets/strips/melee_walk_4f.png');
  ...
  Game.prototype._initGame = function() {
    ...
    if (this._selectedCharacter.id === 'melee') {
      var meleeCfg = { sprites: { idle: { file: 'assets/strips/melee_idle_2f.png', fps: 4 }, run: { file: 'assets/strips/melee_walk_4f.png', fps: 8 } } };
